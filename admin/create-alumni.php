<?php 
include_once('scripts/create-alumni.php'); 
            ...
            <div class="form-sec">
              ...
              <form action="" method="post">
                <ul class="row">
                  ...
                  <li class="col-md-12">
                    <input type="text" placeholder="Faculty" name="faculty" class="form-control" >
                  </li>
                  <li class="col-md-6">
                    <p>Already a member? <a href="#.">Sign In</a></p>
                  </li>
                  <li class="col-md-6"> <input type="submit" name="submit" class="btn-new" value="Submit" /> </li>
                </ul>
              </form>
            </div>
          </div>
