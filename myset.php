...
$query = "SELECT aset FROM members WHERE matno='$user'";
$myset= mysqli_query($dbcon,$query);
$srow = mysqli_fetch_assoc($myset);
$set = $srow['aset'];
$query = "SELECT * FROM members WHERE aset='$set'";
        ...
        <div class="container">
          <div class="page-content">
            ...
            <div class="agent-title">
              <h1 class="pull-left">Alumni Members For <?php echo $set ?>  Set</h1>
