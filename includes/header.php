                ...
                <div class="row">
                  <div class="col-md-3 col-sm-3">
                    <div class="logo-section">
                      <a href="/"><img src="assets/img/logo.png" alt="" width="40" height="40"></a>
                    </div>
                  </div>
            ...
            <div class="non-register-user">
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3">
                    <div class="logo-section">
                      <a href="index-2.html"><img src="assets/img/logo.png" alt="" width="50" height="50"></a>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 col-sm-5">
                    <div class="search-form">
                      ...
                      <form action="search-members.php" method="get">
                        <button class="dropdown-search"><i class="fa fa-caret-down"></i> <i class="fa fa-bars"></i></button>
                        <input type="search" placeholder="Search..." name ="s" class="topbar-search-input">
                        <button class="search-button"><i class="fa fa-search"></i></button>
                      </form>
                  ...
                  <div class="col-md-3 col-sm-4">
                    <div class="notification-section text-right">
                      ...
                      <ul class="list-inline">
                        <li><a href="#"><?php if(isset($_SESSION['matno'])){
                         echo $_SESSION['matno'];
                        }else{
                        ...
                        <li><a href="#"><?php if(isset($_SESSION['matno'])){
                         echo '<a href="includes/logout.php">Logout</a>';
                          ...
                          echo '<a href="member-registration.php">Register</a>'; }?></a></li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                      <a href="jobs.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Job
                        <span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <li><a href="jobs.php">job search</a></li>
                        <li><a href="add-vacancy.php">add job vacancy</a></li>
                      </ul>
                    </li>
                    <li><a href="fund-raising.php">Fund Raising</a></li>
                    <li class="active"><a href="reunion.php">Reunions</a></li>
                    <li class="active"><a href="all-members.php">Alumni Members</a></li>
                    <li class="active"><a href="myset.php">MySet Members</a></li>
